...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	await loadBottomInfo({
		...
		wizards: {name:'wizards', text:'', x:0.0647, y:0.9453, width:0.86, height:0.0134, oneLine:true, font:'invocation-text', size:0.0134, color:'#24150E', align:'right'},
		cc: {text:' ', x:0.0647, y:0.9677, width:0.7467, height:0.0134, oneLine:true, font:'invocation-text', size:0.0134, color:'#24150E', align:'right'}
	});
}
