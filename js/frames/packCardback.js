...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadBottomInfo({
		...
		wizards: {name:'wizards', text:'', x:0.0647, y:0.9549 + 12/2100, width:0.8707, height:0.0167, oneLine:true, font:'mplantin', size:0.0162, color:'white', align:'right', outlineWidth:0.003},
		bottomRight: {text:' ', x:0.0647, y:0.972 + 12/2100, width:0.8707, height:0.0143, oneLine:true, font:'mplantin', size:0.0143, color:'white', align:'right', outlineWidth:0.003}
	});
}
