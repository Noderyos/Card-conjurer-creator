...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadBottomInfo({
		...
		bottom: {text:'{conditionalcolor:Black_Frame,Land_Frame:white}NOT FOR SALE    ', x:0.094, y:1994/2100, width:0.8107, height:0.0134, oneLine:true, font:'mplantin', size:0.0134, color:'black', shadowX:0.0007, shadowY:0.0005}
	});
}
