...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	loadBottomInfo({
		...
		wizards: {name:'wizards', text:'', x:0.094, y:1954/2100, width:0.8107, height:0.0153, oneLine:true, font:'mplantin', size:0.0153, color:'white', align:'right', shadowX:0.0007, shadowY:0.0005},
		bottom: {text:'{conditionalcolor:White_Frame,Artifact_Frame,Colorless_Frame:black}{ptshift-0.1667,0}NOT FOR SALE    ', x:0.094, y:1990/2100, width:0.8107, height:0.0134, oneLine:true, font:'mplantin', size:0.0134, color:'white', align:'right', shadowX:0.0007, shadowY:0.0005}
	});
}
