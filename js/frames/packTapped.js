...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	await loadBottomInfo({
		...
		wizards: {name:'wizards', text:'', x:0.0462, y:0.9607, width:0.9077, height:0.0227, oneLine:true, font:'mplantin', size:0.0227, color:'white', align:'right', outlineWidth:0.003},
		bottomRight: {text:' ', x:227/2100, y:0.9607, width:0.9077, height:0.02, oneLine:true, font:'mplantin', size:0.02, color:'white', align:'center', outlineWidth:0.003}
	});
