...
document.querySelector('#loadFrameVersion').onclick = async function() {
	...
	//bottom info
		await loadBottomInfo({
			...
			wizards: {name:'wizards', text:'', x:0.0647, y:0.9614, width:0.8707, height:0.0167, oneLine:true, font:'gothammedium', size:0.0162, color:'white', align:'center', outlineWidth:0.003},
			bottom: {text:'NOT FOR SALE   {fontmplantin} ', x:0.0647, y:0.98, width:0.8707, height:0.0143, oneLine:true, font:'gothammedium', size:0.0143, color:'white', align:'center', outlineWidth:0.003}
		});
